      ...
      <div className="Body-1">
        ...
        <div className="Body-1-text-section">
          ...
          <div className="Body-1-text">
            <p></p>A technology professional with 5+ years of progressive
            experience in professional services consulting Fortune 500 companies
            across a wide range of industries. Passionate about delivering
            high-impact, value-added initiatives to achieve organizations’
            overall strategic goals.
            <p></p>
            Experienced in delivering projects simultaneously and proficient in
            utilizing Agile, Waterfall and Hybrid methodologies to strive for
            no-surprise implementations. Possesses a proven track record of
            project management, client relationship management, team coaching,
            and collaborating with remote teams while delivering quality
            implementations within budget and timeline.
          </div>
        </div>
      </div>
        ...
        <div className="Body-2-skills">
          ...
          <div className="Body-2-table">
            ...
            <div className="Body-2-card">
              ...
              <div className="Body-2-cardtext">
                Experienced with the following languages and developed this site
                in:
                <br />
                <br />
                react
            ...
            <div className="Body-2-card">hi</div>
          </div>
        </div>
      </div>
    </div>
